...
Route::prefix('/planes')->name('planes.')
    ->middleware([RoleMiddleware::class . ':ADMIN,GESTOR']) // Solo ADMIN y GESTOR
    ->group(function () {
...
Route::prefix('/eventos')->name('eventos.')
    ->middleware([RoleMiddleware::class . ':ADMIN,GESTOR']) // Solo ADMIN y GESTOR
    ->group(function () {
...
Route::prefix('asientos')->name('asientos.')
    ->middleware([RoleMiddleware::class . ':ADMIN,GESTOR']) // Solo ADMIN y GESTOR
    ->group(function () {
...
Route::get('/tickets/send/{id}', [C_Tickets::class, 'sendTicket'])->name('tickets.ticket.sendTicket');
Route::post('/tickets/validar/{id}', [C_Tickets::class, 'validarCodigoQR'])->name('tickets.validar.codigo');
Route::post('/verificar-qr/{codigo}', [C_Tickets::class, 'verificarQr'])->name('tickets.verificarQr');
...
Route::prefix('users')->name('users.')
    ->middleware([RoleMiddleware::class . ':ADMIN']) // Solo ADMIN puede gestionar usuarios
    ->group(function () {
